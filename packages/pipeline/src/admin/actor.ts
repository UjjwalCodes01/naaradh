...
/**
 * Who is changing a tenant's configuration — an API key (apps/api) or a signed-in dashboard
 * user (apps/web, apps/shopify). The admin operations take one so both surfaces write the same
