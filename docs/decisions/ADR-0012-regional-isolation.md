...
merchant's data protection officer will ask exactly where it does sit. The audit before Phase 6
(`docs/phase-reviews/pre-phase-6-audit.md`) found the *calling* core already region-aware —
