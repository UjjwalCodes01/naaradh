...
import { sanitiseMerchantText, type ToolArgsOf, type ToolName } from '@naaradh/call-scripts';
 ...
 * the pure policies in compliance, and returns ONLY what the agent may say. Nothing
