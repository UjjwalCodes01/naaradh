 ...
 * one-shot maintenance process (workers/src/maintenance). Rows are claimed in id-ordered
 ...
 * (`shopify_refresh:<id>`, workers/src/shopify-tokens.ts), non-blocking: a refresh in
