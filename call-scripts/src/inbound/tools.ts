 ...
 *
 *   args        a Zod schema — voice validates every call with it (invariant 18)
...
/** Structurally the engine contract's ToolDefinition (engines/core) — scripts stays engine-free. */
 ...
 * The URL — not anything the model says — is what later tells voice which tenant a tool
 * call belongs to.
 */
