# prod-us — production, United States region (ADR-0012, PLAN Phase 6 P6-INF-1). NO SECRETS IN THIS FILE.
...
project_id  = "naaradh-prod-us"
env         = "prod-us"
data_region = "us"
region      = "us-central1"

github_repo               = "naaradh/naaradh"
github_deploy_environment = "production-us"
tf_state_bucket           = "naaradh-tfstate-prod-us"

deletion_protection = true

# Engine webhooks, the API and the support line for United States merchants. Shopify webhooks still arrive
# at hooks.naaradh.com (one URL per app) and are forwarded here by the region directory.
hostnames = {
  api   = "api.us.naaradh.com"
  hooks = "hooks.us.naaradh.com"
  voice = "voice.us.naaradh.com"
  # Enable together with services.<key>.enabled once the images exist.
  # web     = "app.us.naaradh.com"
  # console = "console.us.naaradh.com"
}
...
common_env = {
  ...
  DND_REGISTRY_REGIONS = "US"
  # The other deployments' hooks, for the region directory (ADR-0012 §4).
  REGION_PEERS = "{\"in\":\"https://hooks.naaradh.com\",\"eu\":\"https://hooks.eu.naaradh.com\"}"
