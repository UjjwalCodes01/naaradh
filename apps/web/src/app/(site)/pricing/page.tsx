      ...
      <div className="space-y-10">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-body">
            ...
            merchants through Razorpay. You set a monthly spending cap; calls pause at the cap
            rather than surprise you.
          </p>
        </div>
        <PlanTable
    ...
    <section>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {plans.map((p) => {
          ...
          return (
            <div key={p.code} className="rounded-2xl border border-line bg-white p-5">
              <h3 className="font-semibold text-ink">{p.name.replace('Support line — ', '')}</h3>
